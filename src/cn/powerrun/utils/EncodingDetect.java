...
public class EncodingDetect {    //检测编码
    
    public static void main(String[] args) {
    	String path = "C:\\Users\\����\\Documents\\WeChat Files\\laitaodeweixin\\Files\\��Է���๫�����վ\\��Է���๫�����վ.json";
        System.out.println(EncodingDetect.detect(path));
    }
